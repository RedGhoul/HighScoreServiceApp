        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FirstName = table.Column<string>(type: "nvarchar(36)", nullable: true),
                    LastName = table.Column<string>(type: "nvarchar(36)", nullable: true),
                    Company = table.Column<string>(type: "nvarchar(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Identifier = table.Column<string>(type: "nvarchar(280)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PromoCodes_Games_GameId",
                        column: x => x.GameId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ScoreBoardIdentifier = table.Column<string>(type: "nvarchar(280)", nullable: true),
                    PlayerName = table.Column<string>(type: "nvarchar(280)", nullable: true),
                    ScoreAmount = table.Column<double>(type: "double", nullable: false),
                    TimeAmount = table.Column<double>(type: "double", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(280)", nullable: true),
